...
router.delete('/delete', async (req, res) => {
    const { id } = req.body;
    //1 is the default delete user where all deleted addresses will go as to not affect foreign key constraints
    const sql = `UPDATE Address SET user_id = 1 WHERE id = ?`;
